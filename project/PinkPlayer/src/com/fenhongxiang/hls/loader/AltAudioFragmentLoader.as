...
package com.fenhongxiang.hls.loader
{
	...
	import com.fenhongxiang.hls.demux.DemuxHelper;
	import com.fenhongxiang.hls.demux.Demuxer;
	import com.fenhongxiang.hls.event.HLSError;
	...
	import com.fenhongxiang.hls.model.Fragment;
	import com.fenhongxiang.hls.model.FragmentData;
	import com.fenhongxiang.hls.model.Level;
	import com.fenhongxiang.hls.stream.StreamBuffer;
	import com.fenhongxiang.hls.utils.AES;
	import com.fenhongxiang.hls.utils.Hex;
	import com.fenhongxiang.hls.utils.Log;
	...
	public class AltAudioFragmentLoader
	{
		...
		private function _fragLoadProgressHandler(event:ProgressEvent):void
		{
			...
			if (event.bytesLoaded > fragData.bytesLoaded && _fragstreamloader.bytesAvailable > 0)
