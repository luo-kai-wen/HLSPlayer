...
package com.fenhongxiang.srt
{
	...
	final public  class SRTController
	{
		...
		private var _srtData:Vector.<SRTData>;
		...
		public function load(path:String):void
		{
			...
			srtLoader.addEventListener(SRTEvent.LOADED, onSRTFileLoaded);
			srtLoader.load(path);
		}
		...
		public  function renderSRT(time:Number, txt:TextField, txtColor:String="#FFFFFF", fontSize:int = 12):void
		{
			if (txt)
			{
				...
				{
					txt.htmlText = "<font color='" +txtColor +"' size='" +fontSize +"' face='微软雅黑'>"+ getContentByTime(time)+"</font>";
				}
			}
		}
		...
		private  function onSRTFileLoaded(e:SRTEvent):void
		{
